...
class DbClient:
    ...
    def __enter__(self) -> typing.Callable:
        ...
        self.connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database, conv = conv, cursorclass=pymysql.cursors.SSCursor)
