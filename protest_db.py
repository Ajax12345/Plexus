...
class DbClient:
    ...
    def __enter__(self) -> typing.Callable:
        ...
        self.connection = pymysql.connect(host=self.host, 
                    ...
                    conv = conv, 
                    cursorclass=pymysql.cursors.SSCursor if not self.__dict__.get('as_dict', False) else pymysql.cursors.DictCursor)
...
if __name__ == '__main__':
    with DbClient(host='localhost', user='root', password='*******', database='protest_db') as cl:
